  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
        <h1 className="text-2xl md:text-3xl font-bold dark:text-white mt-10">Dashboard</h1>
        <Button onClick={exportToExcel} className="flex items-center gap-2 w-full md:w-auto">
